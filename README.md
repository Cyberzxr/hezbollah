...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn:hover { background: #00cc50; transform: scale(0.97); box-shadow: 0 0 30px rgba(0, 255, 100, 0.15); }
        ...
        .status-msg { text-align: center; font-size: 13px; color: #8892b0; margin-top: 10px; min-height: 22px; font-weight: 400; }
        ...
        @media (max-width: 640px) {
            ...
            .email-card .body-preview { font-size: 12px; padding: 12px; max-height: 220px; }
            .btn-group { flex-direction: column; align-items: stretch; }
            .btn, .btn-gmail, .btn-copy { justify-content: center; }
...
<div class="container">
    ...
    <div class="header">
        ...
        <p class="sub">Report a Violating Telegram Channel – Direct Email</p>
    ...
    <div class="to-box">
        <strong>📨 Send to these addresses:</strong><br />
    ...
    <!-- FOOTER -->
    <div class="footer">
        📨 Send to: abuse@telegram.org | dmca@telegram.org | security@telegram.org | grievance-in@telegram.org
...
// CONFIGURATION
// ============================================================
const TO_EMAILS = ["abuse@telegram.org", "dmca@telegram.org", "security@telegram.org", "grievance-in@telegram.org"];
...
// ============================================================
// 50 UNIQUE EMAIL TEMPLATES (FULLY DIFFERENT)
// ============================================================
const templates = [];

// Helper to generate random intro
const intros = [
...
// Generate 50 unique templates
for (let i = 0; i < 50; i++) {
    const intro = intros[i % intros.length];
    const bodyText = bodies[i % bodies.length];
    const suffix = Math.floor(i / intros.length) + 1;
    ...
    const subject = `🚨 URGENT: Report Violating Channel ${CHANNEL_USERNAME} (Report #${i+1})`;
...
This channel must be stopped. It is putting lives at risk and causing real harm. I urge you to investigate and block ${CHANNEL_USERNAME} immediately.
